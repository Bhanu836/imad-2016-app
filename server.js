...
res.end();
 ...
 console.log(req.body.stucity);
    ...
    pool.query('INSERT INTO STU_TEACHER(id,studentname,studentcity,studentcolge_name,wrstteacher_name,wrstteacher_city,wrstteacher_colge_name) VALUES(0,$1,$2,$3,$4,$5,$6)',[0,req.body.stuname, req.body.stucity, req.body.stucollage, req.body.namewt ,req.body.citywt, req.body.collagewt]);
